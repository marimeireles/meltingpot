...
SCENARIO_CONFIGS: Mapping[str, ScenarioConfig] = immutabledict.immutabledict(
    ...
    allelopathic_harvest__open_4=ScenarioConfig(
        description=(
            "focals like red, visited by mixture of convention "
    ...
    allelopathic_harvest__open_6=ScenarioConfig(
        description=(
            "not very crowded, focals like red, visited by mixture "
    ...
    allelopathic_harvest__open_9=ScenarioConfig(
        description=(
            "not very crowded, focals are resident, visited by "
    ...
    allelopathic_harvest__open_10=ScenarioConfig(
        description=(
            "very low population, focals are resident, and like "
    ...
    clean_up_11=ScenarioConfig(
        description="resident focals are visited by a corrigible reciprocator",
        tags={
            "resident",
            "enforcement",
            "reciprocity",
    ...
    clean_up_12=ScenarioConfig(
        ...
        bots_by_role={
            "default": {
                "clean_up__puppet_corrigible_reciprocator_1",
                "clean_up__puppet_corrigible_reciprocator_2",
            },
        },
    ),
    clean_up_13=ScenarioConfig(
        description="focals visit easily corrigible reciprocators",
        tags={
            "visitor",
            "enforcement",
            "reciprocity",
        ...
        bots_by_role={
            "default": {
                "clean_up__puppet_easily_corrigible_reciprocator_0",
    ...
    fruit_market__concentric_rivers_2=ScenarioConfig(
        ...
        tags={"visitor", "convention_following"},
        substrate="fruit_market__concentric_rivers",
        roles=("apple_farmer",) * 8 + ("banana_farmer",) * 8,
    ...
    prisoners_dilemma_in_the_matrix__arena_15=ScenarioConfig(
        description="visting a population of tit-for-tat reciprocator bots",
        tags={
            "visitor",
            "reciprocity",
        },
    ...
    prisoners_dilemma_in_the_matrix__repeated_8=ScenarioConfig(
        description=(
            "visitor tries to take advantage of the focal player "
    ...
    territory__rooms_5=ScenarioConfig(
        description=(
            "focals are resident, visited by a couple considerate " + "claimers"
        ),
        tags={
            "resident",
        },
    ...
    territory__rooms_8=ScenarioConfig(
        description=(
            "focals are resident, visited by an inconsiderate "
    ...
    territory__rooms_9=ScenarioConfig(
        description=(
            "the environment is not as crowded as it could be, "
