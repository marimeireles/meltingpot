...
from meltingpot.configs.substrates import (
    allelopathic_harvest__open, boat_race__eight_races,
    ...
    chemistry__two_metabolic_cycles_with_distractors, clean_up, coins,
    collaborative_cooking__asymmetric, commons_harvest__closed, coop_mining,
    daycare, externality_mushrooms__dense, factory_commons__either_or,
    fruit_market__concentric_rivers, gift_refinements,
...
from meltingpot.human_players import (level_playing_utils,
                                      ...
                                      play_boat_race, play_chemistry,
                                      play_clean_up, play_coins,
                                      play_collaborative_cooking,
                                      play_commons_harvest, play_coop_mining,
                                      play_daycare, play_externality_mushrooms,
                                      play_factory_commons, play_fruit_market,
                                      play_gift_refinements, play_paintball,
                                      play_predator_and_prey, play_territory)
