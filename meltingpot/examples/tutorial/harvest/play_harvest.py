...
flags.DEFINE_integer(
    "screen_width", 800, "Width, in pixels, of the game screen"
)
flags.DEFINE_integer(
    "screen_height", 600, "Height, in pixels, of the game screen"
)
...
flags.DEFINE_bool(
    "display_text", False, "Whether we to display a debug text message"
)
flags.DEFINE_string(
    "text_message",
