...
def main():
    parser = argparse.ArgumentParser(description="Re-create plots from checkpoint CSVs")
    parser.add_argument(
        "checkpoint_dir", type=pathlib.Path, help="Path to your checkpoints directory"
    )
